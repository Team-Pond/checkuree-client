...
const RelationshipSelect = (props: IProps) => {
  ...
  return (
    ...
    >
      <Select.Trigger
        className="inline-flex items-center justify-between w-[120px] px-3 py-2 bg-white border border-border-brand outline-none rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
        aria-label="관계"
      >
